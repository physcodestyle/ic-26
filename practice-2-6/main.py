...
from modules.interpolation import interpolation_1d, IntFuncType
...
def run():
    ...
    x_data = data["cols"][0]
    y_data = data["cols"][3]
    int_func = interpolation_1d(x_list=x_data, y_list=y_data, int_func_type="IntFuncType.Polynomial1")
    print(int_func)
